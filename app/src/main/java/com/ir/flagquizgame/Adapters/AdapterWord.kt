...
class AdapterWord(
    ...
    RecyclerView.Adapter<AdapterWord.VH>() {
        ...
        fun onBind(stringText: String, stringHint: String , position: Int) {
            ...
            itemRV.root.setOnClickListener {
                ...
                if (antiBagBoolean && positionChars != -1 && stringText.isNotEmpty()) {
                    ...
                    arrayListWord[position].stringText = ""
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        holder.onBind(arrayListWord[position].stringText, arrayListWord[position].stringHint, position)
    }

    override fun getItemCount(): Int = arrayListWord.size
